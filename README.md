...
| 🔥 LeetCode Streaks | 50 / 100 / 200 / 365 / 500-day badges |
...
**Stack:** `Next.js` `Flask` `Go` `MongoDB` `GCP`

**What makes it stand out:**
- 🧠 Personalized recommendation pipeline using **TF-IDF, Topic Modeling & Markov Random Fields**
- 🔗 **Graph-based learning with Belief Propagation** to optimize learning paths intelligently
...
**Stack:** `Python` `MySQL` `LangChain` `Streamlit` `Google APIs`

**What makes it stand out:**
- 🔄 End-to-end **NLP pipeline** transforming plain English to structured SQL
- ⚙️ Engineered **LLM prompts** for accurate, context-aware query generation
...
| ☁️ **Google Cloud Skills Boost** | Generative AI Learning Path |
| 💡 **Hackathons Participated** | Walmart Sparkathon · Google Girl Hackathon · Flipkart Runway · Goldman Sachs · Amazon HackOn |
...
| 🧩 Dev | Full-Stack AI Integrations · API Design |
...
- ⚙️ **Technical Volunteer** — Mayukh National Technical Fest · Managed participant workflows & logistics
